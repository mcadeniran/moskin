...
const fetchAllOrders = (): Promise<Order[]> => fetch('/api/admin/orders').then(res => res.json());

const AllOrders = () => {
  const {isLoading, data: orders, error} = useQuery({queryKey: ['allOrders'], queryFn: fetchAllOrders});
